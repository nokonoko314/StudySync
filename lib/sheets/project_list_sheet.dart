...
/// 設定画面から開く「科目（プロジェクト）の管理」シート。
/// ドロワーと同じデータを使い、追加・編集・削除ができます。
void showSubjectsSheet(BuildContext context) {
  showAppSheet(context, title: '科目の管理', bodyBuilder: (ctx) => const _SubjectsBody());
}
        ...
        children: [
          if (state.projects.isEmpty)
            Padding(
              ...
              child: Center(
                child: Text('まだ科目がありません。下のボタンから追加してください。',
          ...
          SizedBox(
            ...
            child: OutlinedButton.icon(
              ...
              label: Text('新しい科目を追加', style: AppTheme.body(13, weight: FontWeight.w700, color: AppColors.indigo)),
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          if (p.start != null && p.end != null)
            Padding(
              ...
              child: Text('テスト期間 ${fmtShort(p.start!)}〜${fmtShort(p.end!)}',
